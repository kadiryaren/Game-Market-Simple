...
function ProductPage() {
	...
	const getServerDataByUrl = (data,slug) => {
		let DATA = data["pvp-items"].concat(data["official-items"]);

		try{
			return DATA.filter((item)=>{

				return item.server === slug;
	...
	return (
	  <div>
		<div className='popup' style={{ "display" : popup}}>
			<div className='close' onClick={togglePopup}>X</div>
			<div className='popup-content text-light'>
				<h1 className='text-light'>Join My Discord Channel For Buy</h1>
				
				<a className='btn btn-lg mt-4 btn-outline-light' href={`${data["information"][1].discord}`}>Join Discord</a>
			</div>
		</div>
		  <div className="main bg-warning bg-dark">
			<nav className="d-flex justify-content-start align-items-center">
			  ...
			  <a
				href="#"
				className="navbar-items text-center h-100 d-flex justify-content-center align-items-center"
			  >
			  ...
			  >
				...
				<span className="m-2"><a href="#footer" className='text-decoration-none text-light'>Contact</a></span>
			  </a>
			  <a
				href="#"
				className="navbar-items text-center h-100  d-flex justify-content-center align-items-center"
			  >
				...
				<span className="m-2"><a className='text-decoration-none text-light' href={`${data["information"][1]["discord"]}`} >Discord</a></span>
			  </a>
			</nav>	
				  <a href={`${data["information"][1]["discord"]}`}  className="discord"><img
				   
					src={require("./assets/images/discord.jpg")}
					alt="pvp image"
				  /></a>
	
				  <a href={`${data["information"][0]["whatsapp"]}`}  className="whatsapp"><img
				   
				   src={require("./assets/images/whatsapp.jpg")}
				   alt="pvp image"
				 /></a>
	
			<div className="main-content w-100 bg-dark mt-1 d-flex justify-content-center align-items-center text-light">
			  
			  
			  <div
							className="card card-product card-hover mt-5 m-3 bg-dark text-light border-warning"
							style={{ width: "18rem" }}
						>
							<img
							src={require(`./assets/images/${
								getServerDataByUrl(data,server)["image-name"]
							}`)}
							className=" product-card-image"
							alt="..."
							/>
							<div className="card-body d-flex flex-column justify-content-center align-items-center">
							<a href="#" className="text-decoration-none -info text-center text-light item-title ">
								{getServerDataByUrl(data,server)["description"]}
							</a>
							...
							<div className="price fs-1 d-flex align-items-center mt-1">
							{getServerDataByUrl(data,server)["price"]}
								<svg
								xmlns="http://www.w3.org/2000/svg"
								width="36"
								height="36"
							...
							<div onClick={togglePopup} className="buy w-100 buy-button fs-3 mt-3  bg-warning text-dark rounded d-flex justify-content-center align-items-center">
								<svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
								...
								<span className="m-2 buy-item" >Buy</span>
							</div>
							</div>
						</div>
			</div>
		  ...
		  <footer id="footer" className="text-center w-100 text-lg-start bg-dark text-muted text-light">
	...
	<section>
	  ...
	  <div className="container text-center text-md-start mt-5">
		...
		<div className="row mt-3">
			<div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 d-flex justify-content-end align-items-start">
			<img
		  ...
		  <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
			...
			<h6 className="text-uppercase text-center fw-bold mb-4"><a href="#footer" className='text-decoration-none'>Contact</a></h6>
			<p className='text-center'><i className="fas fa-home me-3 text-grayish"></i>215 Heronswood Rd Welwyn Garden City United Kingdom</p>
			<p className='text-center'>
			  <i className="fas fa-envelope me-3 text-grayish"></i>
			  sagestore@gmail.com
			</p>
			<p className='text-center'> <i className="fas fa-phone me-3 text-grayish"></i>+44 07361192110</p>
	...
	<div className="text-center p-4" style={{"backgroundColor":"rgba(0, 0, 0, 0.025)"}}>
	  © 2022 Copyright:
	  <a className="text-reset fw-bold m-2" href="#">Sage Store</a>
	</div>
...
function Home() {
	...
	const navigateToProduct = (serverName) => {
		navigate(`/products/${serverName}#logo`);
	}

	// useEffect(() => {
	// 	if(redirectToProduct){
	// 		navigate(`/products/${redirectToProduct}`);
	// 	}
		...
		<span className="text-light fs-3 m-3">Discord! </span>
			...
			>
			  <div className="carousel-inner">
				<div className="carousel-item active" data-bs-interval="5000">
				  <img
					src={require("./assets/images/mainCarousel.png")}
		  ...
		  <div className="strip d-flex justify-content-around align-items-center">
			...
			<div className="secure-trade d-flex text-light align-items-center">
			  ...
			  <span className="fs-3 m-2">Secure Payment </span>
			</div>
		  </div>
				...
				{data['pvp-items'].map((item) => {
					return (
						...
						>
							...
							<div onClick={() => {
								navigateToProduct(item.server)

							}} className="buy w-100 buy-button fs-3 mt-3  bg-warning text-dark rounded d-flex justify-content-center align-items-center">
								<svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
		...
		<>
			<Router>
				<Routes>
					...
					<Route  path="/products/:server"  element={<ProductPage  />}  />
				</Routes>
			</Router>
		</>
	);
