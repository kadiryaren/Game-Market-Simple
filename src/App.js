	  ...
	  <div className="App d-flex flex-column justify-content-start  align-items-center">
		<div className='popup' style={{ "display" : popup}}>
			...
			<div className='popup-content'>
				<h1>React Us on Discord Channel!</h1>
				<p>Join our Discord channel and ask questions, share your projects and get help from other developers!</p>
				<a href={`${data["information"][1].discord}`}>Join Discord</a>
			</div>
		</div>
				...
				{data['pvp-items'].map((item) => {
					return (
						...
						>
							...
							<a href="#" className="text-decoration-none -info text-center item-title ">
								{item.description}
							</a>
							...
							<div onClick={togglePopup} className="buy w-100 buy-button fs-3 mt-3  bg-success rounded d-flex justify-content-center align-items-center">
								<svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
